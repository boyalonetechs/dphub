    ...
    <>
      <section className="w-full bg-white py-12 px-4 md:px-6 md:py-24">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          {/* Header Badge */}
          <ScrollReveal animation="fade-up" className="inline-block bg-gradient-to-b from-[#E7F644] to-[#25D366] px-6 md:px-8 py-2 rounded-xl shadow-md mb-10 md:mb-16">
          ...
          <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
            ...
            <ScrollReveal animation="fade-up" delay={100} className="relative border rounded-[2.5rem]  p-8 md:p-10 flex flex-col justify-between overflow-hidden transition-transform duration-300 hover:scale-[1.01] bg-[#F5F5F5] text-black min-h-[320px] shadow-[0px_6px_1px_#000]">
            ...
            <ScrollReveal animation="fade-up" delay={200} className="relative border rounded-[2.5rem]  p-8 md:p-10 flex flex-col justify-between overflow-hidden transition-transform duration-300 hover:scale-[1.01] bg-[#FFEB3B] text-black min-h-[320px] md:col-span-1 shadow-[0px_6px_1px_#000]">
              <div className="max-w-[55%] z-10 flex flex-col justify-between h-full items-start">
                <div>
                  ...
                  <p className="text-xs md:text-sm font-medium opacity-90 leading-relaxed">
                    We help businesses grow through content creation, social
                    media marketing, and paid ads that drive real sales.
                  </p>
                </div>
                <a
                  href="#"
            ...
            <ScrollReveal animation="fade-up" delay={100} className="relative border border-black rounded-[2.5rem] p-8 md:p-10 flex flex-col justify-between overflow-hidden transition-transform duration-300 hover:scale-[1.01] bg-[#0B0A75] text-white min-h-[200px] md:min-h-[250px] lg:min-h-[320px] shadow-[0px_6px_1px_#000] ">
              <div className="max-w-[55%] z-10 flex flex-col justify-between h-full items-start">
                <div>
                  <div className="inline-flex flex-col mb-4 items-start">
                    <span className="bg-white text-black font-bold text-lg md:text-xl px-3 py-0.5 rounded-md shadow-sm">
            ...
            {/* ==================== 3. DREAMJOB9JA CARD ==================== */}
            <ScrollReveal animation="fade-up" delay={200} className="relative border border-black rounded-[2.5rem] p-8 md:p-10 flex flex-col justify-between overflow-hidden transition-transform duration-300 hover:scale-[1.01] bg-[#2196F3] text-white min-h-[320px] shadow-[0px_6px_1px_#000]">
              <div className="max-w-[55%] z-10 flex flex-col justify-between h-full items-start">
                <div>
            ...
            {/* ==================== 1. DPLEARN CARD ==================== */}
            <ScrollReveal animation="fade-up" delay={100} className="relative border border-black rounded-[2.5rem] p-8 md:p-10 lg:py-20 flex flex-col justify-between overflow-hidden transition-transform duration-300 hover:scale-[1.01] bg-[#7F26FD] text-white col-span-1 md:col-span-2 min-h-[200px] md:min-h-[300px] lg:min-h-[400px] shadow-[0px_6px_1px_#000]">
            ...
            <ScrollReveal animation="fade-up" delay={100} className="relative border border- rounded-[2.5rem] p-8 md:p-10 flex flex-col justify-between overflow-hidden transition-transform duration-300 hover:scale-[1.01] bg-[#00E676] text-black min-h-[320px] shadow-[0px_6px_1px_#000]">
              <div className="max-w-[55%] z-10 flex flex-col justify-between h-full items-start">
                <div>
                  <div className="inline-flex flex-col mb-4 items-start">
                    <span className="bg-white text-black font-bold text-lg md:text-xl px-3 py-0.5 rounded-md shadow-sm">
                  ...
                  <p className="text-xs md:text-sm font-medium opacity-90 leading-relaxed">
                    An audio guide that shows you how to land your dream job
            ...
            {/* ==================== 5. HACKATHON & VC CARD ==================== */}
            <ScrollReveal animation="fade-up" delay={200} className="relative  rounded-[2.5rem] p-8 md:p-10 flex flex-col justify-between overflow-hidden transition-transform duration-300 hover:scale-[1.01] bg-[#1A1A24] text-white min-h-[290px] outline-2 outline-black border-white border-5">
              <div className="max-w-[55%] z-10 flex flex-col justify-between h-full items-start">
                <div>
                  <div className="inline-block bg-white text-black font-bold text-lg md:text-xl px-3 py-0.5 rounded-md mb-4 shadow-sm">
